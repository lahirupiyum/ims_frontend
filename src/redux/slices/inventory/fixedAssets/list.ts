...
import { fixedAssetListUrl } from "../../../../utils/url-properties/urls/inventory/fixedAssests";
...
export const fixedAssetListAction = () =>
  globalListAction<FixedAssetResponse>(fixedAssetListUrl, listActionTypes);
