...
import { mobileAssetListUrl } from "../../../../utils/url-properties/urls/inventory/mobileAssets";
...
export const mobileListAction = () =>
  globalListAction<MobileAssetResponse>(mobileAssetListUrl, listActionTypes);
